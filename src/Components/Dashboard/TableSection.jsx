...
export const TableSection = () => {
  ...
  return (
    <div className="space-y-6">
      <div className="bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl rounded-b-2xl border-slate-200/50 dark:border-slate-700/50 overflow-hidden">
        ...
        <div className="overflow-y-auto">
          <table className="w-full">
            ...
            <tbody className="border-b border-slate-200/50 dark:border-slate-700/50 hover:bg-slate-50/50 dark:hover:bg-slate-800/50 transition-colors">
      ...
      {/* Top products */}
      <div className="bg-white/80 dark:bg-slate-900 backdrop-blur-xl rounded-2xl border border-slate-200/50 dark:border-slate-700/50 overflow-hidden">
        <div className="p-6 border-b border-slate-200/50 dark:border-slate-700/50 ">
          <div className="flex items-center justify-between">
