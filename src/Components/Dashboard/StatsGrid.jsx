      ...
      {stats.map((stats, index) => (
        ...
        >
          <div className="flex items-start justify-between">
            ...
            <div
              className={`rounded-xl ${stats.bgColor} p-3 group-hover:scale-110 transition-all duration-300`}
            >
          ...
          <div className="mt-4 h-2 bg-slate-100 dark:bg-slate-800 rounded-full overflow-hidden">
            <div
              className={`h-full bg-gradient-to-r ${stats.color} rounded-full transition-all duration-200`}
